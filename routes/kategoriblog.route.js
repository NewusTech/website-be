...
route.get('/admin/kategoriblog/get', [mid.isLogin, mid.isLogout], kategoriblogController.getkategoriblog);
route.get('/admin/kategoriblog/get/:id', [mid.isLogin, mid.isLogout], kategoriblogController.getkategoriblogById);
