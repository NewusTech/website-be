...
route.get("/admin/tagportofolio/get",  tagportofolioController.gettagportofolio);
route.get("/admin/tagportofolio/get/:id", tagportofolioController.gettagportofolioById);
