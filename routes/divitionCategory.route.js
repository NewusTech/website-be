...
router.get("/admin/divitioncategory/lists", [mid.isLogin, mid.isLogout], divitionCategoryLists);
router.post("/admin/divitioncategory/category", [mid.isLogin, mid.isLogout], newDivitionCategory);
router.get("/admin/:id/divitioncategory/detail", [mid.isLogin, mid.isLogout], divitionCategoryDetails);
